    ...
    return (
        ...
        <aside className="w-1/5 bg-white border-r border-gray-200 shadow-sm">
            ...
            <nav className="p-4 space-y-4">
                ...
                <a onClick={listaHabitos} className="flex items-center space-x-2 text-sm font-medium text-gray-700 hover:text-lime-600 cursor-pointer">
                ...
                <a onClick={listaEjercicios} className="flex items-center space-x-2 text-sm font-medium text-gray-700 hover:text-lime-600 cursor-pointer">
                    <span className="material-icons">fitness_center</span><span>Mis Ejercicios</span>
                </a>
                <a onClick={gestionRutinas} className="flex items-center space-x-2 text-sm font-medium text-gray-700 hover:text-lime-600 cursor-pointer">
                    <span className="material-icons">insert_chart</span><span>Mis Rutinas</span>
                </a>
                <a onClick={editProfile} className="flex items-center space-x-2 text-sm font-medium text-gray-700 hover:text-lime-600 cursor-pointer">
